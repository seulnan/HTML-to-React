...
function StartPage({ startGame }) {
  ...
  style={{
    width: 'auto',
    height: 'auto',
    backgroundColor: symbol === 'X' ? '#A8BFC9' : 'transparent', // 선택된 경우 배경색 변경
    border: 'none',
    borderRadius: '8px',
    cursor: 'pointer',
    display: 'flex',
...
>
  <svg
    ...
    style={{
      fill: symbol === 'X' ? '#1A2A33' : '#A8BFC9', // 선택된 경우 색상 변경
    ...
    />
          ...
          <button
            ...
            style={{
              width: 'auto',
              height: 'auto',
              backgroundColor: symbol === 'O' ? '#A8BFC9' : 'transparent', // 선택된 경우 배경색 변경
              border: 'none',
              borderRadius: '8px',
              cursor: 'pointer',
              display: 'flex',
