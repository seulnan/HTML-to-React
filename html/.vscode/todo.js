document.addEventListener('DOMContentLoaded', () => {
    ...
    const updateTaskList = () => {
        ...
        tasks.forEach((task, index) => {
            ...
            taskItem.innerHTML = `
    <input type="checkbox" class="custom-checkbox" ${task.completed ? 'checked' : ''} data-index=${index} />
    ...
    <span class="delete-icon"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M17.6777 0.707107L16.9706 0L8.83883 8.13173L0.707107 0L0 0.707107L8.13173 8.83883L0 16.9706L0.707106 17.6777L8.83883 9.54594L16.9706 17.6777L9.54594 8.83883L17.6777 0.707107Z" fill="#494C6B"/>
    </svg></span>
`;
